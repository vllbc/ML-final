...
def main(cfg: DictConfig) -> None:
    ...
    for i in range(cfg.trainer.num_experiments):
        ...
        if model_name == 'HTFN' and 'htfn_optimizer' in cfg.trainer:
            ...
            optimizer = instantiate(cfg.trainer.htfn_optimizer, params=model.parameters())
    ...
    with open(f"results/{model_name}_{cfg.data.output_window_size}_results.json", "w") as f:
        json.dump(results, f)
